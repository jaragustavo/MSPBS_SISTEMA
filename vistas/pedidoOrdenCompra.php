              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Pedido Orden Compra <button class="btn btn-success"
                           ...
                           <h1 class="box-title"><button class="btn btn-primary"
                              id="btnMostrarEnviar" onclick="mostrarEnviar()"><i class="fa fa-paper-plane" aria-hidden="true"></i> Enviar</button></h1>
                              <h1 class="box-title"><button class="btn btn-danger"
                              id="btnAnular" onclick="anular()"><i class="fa fa-close" aria-hidden="true"></i> Anular</button></h1>
                    </div>
                    ...
                    <!--Fin centro -->
                      ...
                      <div class="panel-body" style="height: 100%;" id="divformularioConsulta">
