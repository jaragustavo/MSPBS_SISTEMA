              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Pedido Orden Compra - Asignar Prioridad<button class="btn btn-success"
                    ...
                    <!--Fin centro -->
                      ...
                      <div class="panel-body" style="height: 100%;" id="formularioconsulta">
                       ...
                       <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <label>Codigo:</label>
                               <input type="text" class="form-control" name="idmedicamento" id="idmedicamento"  disabled="true">
                           </div>  
...
require 'footer.php';
?>
  <script type="text/javascript" src="scripts/pedidoOrdenCompraAsignarPrioridad.js"></script>
<?php 
}
ob_end_flush();
?>