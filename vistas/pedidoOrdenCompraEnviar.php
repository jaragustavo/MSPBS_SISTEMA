              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Pedido Orden Compra <button class="btn btn-success"
                              id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle">
                          </i> Agregar</button></h1>
                         <h1 class="box-title"><button class="btn btn-warning"
                              id="btnMostrarEnviar" onclick="mostrarEnviar()">
                                 <i class="fa fa-paper-plane" aria-hidden="true"></i> Enviar</button></h1>
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                           ...
                           <div id="seleCierre" class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Obs:</label>
                            <input type="text" class="form-control" name="obs" id="obs" required="" disabled="true" onkeyup="contarPalabras( this, 10,'obs' );">
                           </div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/pedidoOrdenCompraEnviar.js"></script>
<script type="text/javascript" src="scripts/contarPalabras.js"></script>
