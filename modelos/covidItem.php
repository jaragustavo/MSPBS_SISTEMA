...
Class ItemCovid
{
    ...
    public function insertar($codigo_catalogo,$item_numero,$nombre,$especificacion_tecnica,$presentacion,$presentacion_entrega,$monto,$cantidad_necesitada,$observacion,$fecha_inicio,$fecha_cierre,$condicion_item,$imagen)
    {
    ...
    {
            $sql="SELECT codigo,codigo_catalogo,item_numero,nombre,especificacion_tecnica,presentacion,presentacion_entrega,monto,cantidad_necesitada,observacion,to_char (fecha_inicio, 'DD-MM-YYYY') as fecha_inicio,to_char (fecha_cierre, 'DD-MM-YYYY') as fecha_cierre,(select descripcion from estado_covid where codigo=codigo_estado) as codigo_estado,imagen  FROM item_covid";
            return ejecutarConsulta($sql);		
    }
