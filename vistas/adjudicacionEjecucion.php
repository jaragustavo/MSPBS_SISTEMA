              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Adjudicación Ejecución<button class="btn btn-success"
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            ...
                            <th>Monto Emitido</th>
                            <th>Saldo</th>
                            <th>Porcentaje Emitido</th>
                            <th>Ejecución Mayor al 50%</th>
                            <th>Estado Stock</th>
                            <th>Estado Contrato</th> 
                            <th>Cantidad Ampliacion</th>  
                            <th>Porcentaje Ampliado</th>
                            <th>Porcentaje Ampliacion Emitido</th>
                            <th>Obs.</th>
                          </thead>
                          <tbody>                            
                          </tbody>
...
require 'footer.php';
?>
  <script type="text/javascript" src="scripts/adjudicacionAdjudicacion.js"></script>
<?php 
}
ob_end_flush();
?>