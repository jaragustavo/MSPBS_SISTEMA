    ...
    case 'listar':
        ...
        while($reg = pg_fetch_row($rspta)){
            $data[]=array(
                ...
                '<button class="btn btn-primary" onclick="mostrarMovimiento('.$reg[0].','.$reg[3].',\''.$reg[4].'\')"><i class="fa fa-eye"></i></button><button class="btn btn-success active" onclick="mostrar('.$reg[0].','.$reg[3].')"><i class="fa fa-pencil"></i></button>',
