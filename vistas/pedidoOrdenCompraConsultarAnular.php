...
if ($_SESSION['pedidoConsultarAnular']==1)
{
?>
<!--Contenido-->
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Pedido Orden Compra - Anular <button class="btn btn-success"
                     ...
                     <div class="panel-body" style="height: 100%;" id="formularioconsulta">
                        <form name="formularioConsulta" id="formularioConsulta" method="POST">
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="numero_pedido" id="numero_pedido" required="" disabled="true">
                           </div>  
                       
                            <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <label>Codigo:</label>
                           <input type="text" class="form-control" name="codigo_medicamento" id="codigo_medicamento" required="" disabled="true">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/pedidoOrdenCompraConsultarAnular.js"></script>
