...
function listar()
{
        tabla=$('#tbllistado').dataTable(
        {
         ...
         "ajax":
           {
            url: '../ajax/pedidoOrdenCompraEnviar.php?op=listar',
            type : "get",
            dataType : "json",      
            error: function(e){
...
function mostrarEnviar()
{
   ...
   // alert("idcodigo "+idcodigo);
    ...
    {    
        ...
        $.post("../ajax/pedidoOrdenCompraEnviar.php?op=mostrarEnviar",{idcodigo : idcodigo}, function(data, status)
        {
        ...
        $.post("../ajax/pedidoOrdenCompraEnviar.php?op=listarDetalle&id="+idcodigo,function(r){
                $("#detalles").html(r);
        });
    }
}
...
function enviar()
   {
    ...
    $.ajax({
        url: "../ajax/pedidoOrdenCompraEnviar.php?op=enviar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
