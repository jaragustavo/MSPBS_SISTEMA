              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Solicitud CDP <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Generar</button></h1>
                    ...
                    <div class="panel-body" style="height: 100%;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                            ...
                            <label>Codigo:</label>
                            <input type="text" class="form-control" name="codigo_solicitud_cvp" id="codigo_solicitud_cvp" disabled="true">
                           </div>  
...
require 'footer.php';
?>
  <script type="text/javascript" src="scripts/solicitudCvp.js"></script>
<?php 
}
ob_end_flush();
?>